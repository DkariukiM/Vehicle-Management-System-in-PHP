...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="<?php echo BASE_URL . '/Dashboard/reports/index.php'  ?>">
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> <a href="<?php echo BASE_URL . '/dashboard/dashboard.php'  ?>"><?php echo $_SESSION['username']; ?></a>, made with love for a better web
                </p>
            </div>
        </footer>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'pe-7s-gift',
            	message: "Hi <?php echo $_SESSION['username']; ?>. Remember to check your notifications. Have a lovely time."
