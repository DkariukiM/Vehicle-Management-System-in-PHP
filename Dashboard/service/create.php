...
<head>
    ...
    <title> Create Service Request || <?php echo $_SESSION['username'] ?></title>
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title"> Create Service Request </h4>
                    </div>
                    <div class="content">
                                    ...
                                    <form action="create.php" method="post">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputStation"> Vehicle Number Plate </label>
                                                <select id="inputStation" name="vehicle_id" class="form-control">
                                                    <option selected value=""> </option>
                                                    <?php foreach ($plates as $key => $plate): ?>

                                                        <?php if (!empty($number_plate) && $number_plate === $plate['id']): ?>
                                                            <option selected value="<?php echo $plate['id'];?>"> <?php echo $plate['number_plate'];?> </option>
                                                        <?php else: ?>
                                                            <option value="<?php echo $plate['id'];?>"> <?php echo $plate['number_plate'];?> </option>
                                                        <?php endif; ?>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                        ...
                                        <input type="submit" name="create-request" class="btn btn-primary" value="Create Request">
                                    </form>
