...
<head>
    ...
    <title> Edit Service Request || <?php echo $_SESSION['username'] ?></title>
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title"> Edit Service Request </h4>
                    </div>
                    <div class="content">
                            ...
                            <div class="card">
                                <div class="content">
                                    <form action="create.php" method="post">
                                        ...
                                        <input type="submit" name="update-request" class="btn btn-primary" value="Create Request">
                                    </form>
