...
<head>
    ...
    <title> Add Service Station || <?php echo $_SESSION['username'] ?></title>
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title"> Add Service Station </h4>
                    </div>
                    <div class="content">
                            ...
                            <div class="card">
                                <div class="content">
                                    <form action="station.php" method="post">
                                        ...
                                        <input type="submit" class="btn btn-primary" name="add-station" value=" Add Station "/>
                                    </form>
