...
$personals = selectAll($table,['id' => $_SESSION['id']]);
...
<head>
    ...
    <title> User Management || <?php echo $_SESSION['username']; ?></title>
                                            ...
                                            <div class="card">
                                                <?php if ($_SESSION['admin']): ?>
                                                    ...
                                                    <div class="content table-responsive table-full-width">
                                                        <table class="table table-hover table-striped">
                                                            ...
                                                            <?php foreach ($user_details as $key => $user_detail) :?>
                                                                <tr>
                                                                    <td><?php echo $key + 1; ?></td>
                                                                    <td><?php echo $user_detail['username']; ?></td>
                                                                    <td><?php echo $user_detail['national_ID']; ?></td>
                                                                    <td><?php echo $user_detail['email']; ?></td>
                                                                    <td><?php echo $user_detail['phonenumber']; ?></td>
                                                                    <?php if ($user_detail['admin']): ?>
                                                                    <td> Admin User </td>
                                                                    <?php else: ?>
                                                                    <td> User </td>
                                                                    <?php endif; ?>
                                                                    <td class="td-actions text-left">
                                                                        <a href="edit_user.php?u_id=<?php echo $user_detail['id'];?>"><button type="button" rel="tooltip" title="Edit User Details" class="btn btn-info btn-simple btn-xs">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button></a>
                                                                        <a href="index.php?u_del_id=<?php echo $user_detail['id'];?>"><button type="button" rel="tooltip" title="Remove User" class="btn btn-danger btn-simple btn-xs">
                                                                                <i class="fa fa-times"></i>
                                                                            </button></a>
                                                                        <a href="index.php?u_id=<?php echo $user_detail['id'];?>"><button type="button" rel="tooltip" title="View User Details" class="btn btn-info btn-simple btn-xs" data-toggle="modal" data-target="#myModal">
                                                                                <i class="fa fa-eye"></i>
                                                                            </button></a>
                                                                    </td>
                                                                </tr>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <div class="header">
                                                        ...
                                                        <p class="category"> <?php echo $_SESSION['username'] ?> Details</p>
                                                    </div>
                                                    <div class="content table-responsive table-full-width">
                                                        <table class="table table-hover table-striped">
                                                            <thead>
                                                            ...
                                                            <?php foreach ($personals as $key => $personal) :?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $personal['national_ID']; ?></td>
                                                                    <td><?php echo $personal['email']; ?></td>
                                                                    <td><?php echo $personal['phonenumber']; ?></td>
                                                                    <td class="td-actions text-left">
                                                                        <a href="edit_user.php?u_id=<?php echo $personal['id'];?>"><button type="button" rel="tooltip" title="Edit User Details" class="btn btn-info btn-simple btn-xs">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button></a>
                                                                    </td>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title"> <?php echo $username ?> Profile: </h4>
                                            </div>
