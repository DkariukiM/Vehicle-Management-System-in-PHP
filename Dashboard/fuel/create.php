    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title"> Create Fuel Request </h4>
                    </div>
                    <div class="content">
                                    ...
                                    <form action="create.php" method="post">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select id="inputStation" name="number_plate" class="form-control">
                                                    <option selected value=""> </option>
                                                    <?php foreach ($plates as $key => $plate): ?>

                                                        <?php if (!empty($number_plate) &&$number_plate === $plate['id']): ?>
                                                            <option selected value="<?php echo $plate['number_plate'];?>"> <?php echo $plate['number_plate'];?> </option>
                                                        <?php else: ?>
                                                            <option value="<?php echo $plate['number_plate'];?>"> <?php echo $plate['number_plate'];?> </option>
                                                        <?php endif; ?>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
